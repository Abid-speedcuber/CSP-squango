            ...
            <div class="modal-content" style="max-width: 500px;">
                ...
                <div class="modal-body">
                    ...
                    <div style="display: flex; gap: 10px; justify-content: center; flex-wrap: wrap;">
                        <button onclick="exportData(); showToast('Data exported! You can now safely reload.', 3000, 'success');" style="padding: 10px 20px; background: transparent; color: var(--good-case); border: 2px solid var(--good-case); border-radius: 6px; cursor: pointer; font-weight: 600; transition: all 0.2s;" onmouseover="this.style.background='var(--good-case)';this.style.color='#fff'" onmouseout="this.style.background='transparent';this.style.color='var(--good-case)'">Export First</button>
                        <button onclick="this.closest('.modal').remove(); document.documentElement.classList.remove('scroll-locked'); closeSidebar(); applyPreset(\`${presetName}\`, false, false).then(() => { if(typeof initializePresetSelector === 'function') initializePresetSelector(); });" style="padding: 10px 20px; background: transparent; color: var(--bad-case); border: 2px solid var(--bad-case); border-radius: 6px; cursor: pointer; font-weight: 600; transition: all 0.2s;" onmouseover="this.style.background='var(--bad-case)';this.style.color='#fff'" onmouseout="this.style.background='transparent';this.style.color='var(--bad-case)'">Reload Anyway</button>
