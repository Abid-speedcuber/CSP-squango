...
const PRECACHE = [
    ...
    "./css/quick-edit.css",
    "./css/svg-editor.css",
    "./res/shapeImages/svg.js",
    "./database/shapeIndex.js",
    "./database/algs.js",
    "./js/tools/utils.js",
    "./js/tools/scrambleNormalizer.js",
    "./js/tools/alg_to_index.js",
    "./js/tools/cales-parity-tracer.js",
    "./js/tools/svg-editor.js",
    "./js/tools/scramblegenerator.js",
    "./js/tools/draw-scramble.js",
    "./js/tools/scrambleFormatting.js",
    "./js/tools/animate-alg.js",
    "./js/restoftheapp.js",
    "./js/tools/shapeTracer.js",
    "./js/rendering.js",
    "./js/search-and-filter.js",
    "./js/tools/scrambled-state-generator.js",
    "./js/settings.js",
    "./js/modals.js",
    "./js/quick-edit.js",
