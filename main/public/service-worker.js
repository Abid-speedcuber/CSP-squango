...
// The JS bundle is hashed by Vite, so it can't be listed here — network-first
// picks it up on the first visit and keeps it for offline use.
const PRECACHE = [
    "./",
    "./index.html",
